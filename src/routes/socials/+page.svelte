...
<svelte:head>
	<title>Connect with Dipan Dhali | Social Links</title>
	<meta
		name="description"
		content="Connect with Dipan Dhali across GitHub, LinkedIn, coding profiles, and more."
	/>
</svelte:head>
	...
	<div class="mt-12 text-center">
		<p class="text-subtext1 text-sm">
			...
			<a
				...
				class="link text-accent font-medium hover:underline"
			>
