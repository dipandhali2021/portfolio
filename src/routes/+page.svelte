	...
	<section class="space-y-5 px-4 md:px-0">
		<h1 class="text-3xl font-bold md:text-4xl">
			...
			<span class="text-accent">
				<span class="sr-only select-none">Dipan</span>
				<span aria-hidden="true">
					<span>Di</span><span
						...
						tabindex="0"
						role="button"
						aria-label="Hover or focus to see why I chase DX">p</span
					><span>an</span>
					<span class:hidden={!isNameHovered}>'DX-first'</span>
				</span>
				<span> Dhali</span>
			</span>
		</h1>
		<p class="text-subtext0 max-w-prose text-lg leading-relaxed">
			I'm a full stack engineer and ECE undergrad at IIITDM Jabalpur, currently interning with the
			DX platform team at <a
				class="link text-accent/85"
				target="_blank"
				rel="noopener"
				href="https://www.members.co.jp/">Members Co., Ltd</a
			>. I love translating ambiguous DevOps problems into friendly dashboards, calm APIs, and
			resilient pipelines.
		</p>
		<p class="text-subtext0 max-w-prose text-lg leading-relaxed">
			My recent work spans Gemini-powered DX courseware for <a
				class="link text-accent/85"
				target="_blank"
				rel="noopener"
				href="https://dxtalent.vercel.app">DXTalent</a
			>, Keycloak+jBPM automation for
			<a
				class="link text-accent/85"
				target="_blank"
				rel="noopener"
				href="https://codeforgovtech.in/">Code For GovTech / The Mifos Initiative</a
			>, Grafana/Prometheus observability for beneficiary platforms, and a VS Code extension called
			Pathos that keeps indie devs honest about their focus time. I'm happiest when developer
			experience meets real human impact.
		</p>
